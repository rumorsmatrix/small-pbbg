...
class Tracery {
	...
	/**
	 * If optionally passed a string, attempts to use it as a JSON filename to load grammar
	...
	/**
	 * Loads a grammar array from a JSON file; use static::GRAMMAR_PATH to configure
	 *
